...
const commande =
{
    sondage: (): SlashCommandBuilder =>
    {
        let comm = new SlashCommandBuilder()
        .setName("sondage")
        .setDescription("Créer un sondage");
        
        comm.addStringOption(option => option.setName("question").setDescription("Question à poser").setRequired(true))
    ...
    sondage_rdva: (): SlashCommandBuilder =>
    {
        let comm = new SlashCommandBuilder()
